...
export type WidgetId = 'categoryPair' | 'trends' | 'budgets' | 'counterparties' | 'accountActivity';

// Collapsible section IDs for persistence
export type SectionId = 'summary' | 'categories' | 'incomeCategories' | 'trends' | 'budgets' | 'counterparties' | 'byAccount';
...
export const DEFAULT_WIDGET_ORDER: WidgetId[] = ['categoryPair', 'trends', 'budgets', 'counterparties', 'accountActivity'];
