...
export type WidgetId = 'categoryPair' | 'trends' | 'budgets' | 'counterparties' | 'accountActivity' | 'patterns' | 'anomalies';
...
export const DEFAULT_WIDGET_ORDER: WidgetId[] = ['categoryPair', 'trends', 'budgets', 'counterparties', 'accountActivity', 'patterns', 'anomalies'];
