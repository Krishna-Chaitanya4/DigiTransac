      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">Spending Analysis</h2>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">Income vs Expenses</h2>
          </div>
          <p className="text-gray-500 dark:text-gray-400 text-sm mb-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">Trends</h2>
          </div>
          <p className="text-gray-500 dark:text-gray-400 text-sm mb-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">Budget Progress</h2>
          </div>
          <p className="text-gray-500 dark:text-gray-400 text-sm mb-4">
