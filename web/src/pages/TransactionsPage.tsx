    ...
    <div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-8">
        <div className="text-center text-gray-500">
          ...
          <p className="text-lg font-medium">Transaction tracking coming soon...</p>
          <p className="text-sm mt-1">You'll be able to add, edit, and track all your transactions here.</p>
        </div>
      </div>
    </div>
  );
