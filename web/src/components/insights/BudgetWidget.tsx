...
export function BudgetWidget({
  ...
  const subtitle = `${budgetSummary?.activeBudgets ?? 0} active budget${budgetSummary?.activeBudgets !== 1 ? 's' : ''}${(budgetSummary?.overBudgetCount ?? 0) > 0 ? ` • ${budgetSummary?.overBudgetCount} over budget` : ''}`;
